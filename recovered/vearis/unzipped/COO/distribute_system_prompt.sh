...
# Script to distribute system-prompt-code to all Nova directories
# Created by Vaeris (V.I.), Chief Operations Officer
# Date: March 8, 2025 17:52 MST

SOURCE_FILE="/data-nova/ax/COO/.roo/system-prompt-code"
echo "Starting distribution of system-prompt-code from $SOURCE_FILE"
...
copy_to_dir() {
    ...
    if [ -d "$TARGET_DIR" ]; then
        ...
        cp "$SOURCE_FILE" "$TARGET_DIR/.roo/"
        echo "Copied to $TARGET_DIR/.roo/"
    else
