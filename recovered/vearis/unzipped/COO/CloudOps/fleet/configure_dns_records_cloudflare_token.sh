#!/bin/bash
# Script to configure DNS records for the mail server using Cloudflare API Token
# Created: 2025-03-29
...
CLOUDFLARE_API_TOKEN="cH-8tuZdztKZyYvc2JlJRk78_TDksULXJ2WesbcC"
CLOUDFLARE_ZONE_ID="18017056a1f7256cff2e02199ed060e1"
...
# Verify API token
print_section "Verifying Cloudflare API Token"
...
if [ "$TOKEN_STATUS" != "active" ]; then
    print_error "API token is not active. Please check your credentials."
