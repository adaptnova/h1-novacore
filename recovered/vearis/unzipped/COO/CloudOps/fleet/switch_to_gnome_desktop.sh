#!/bin/bash
# Script to switch Chrome Remote Desktop from Xfce to GNOME desktop
# Created: 2025-03-29
...
# Ask if the user wants to remove Xfce
print_section "Xfce Removal Options"
echo "Do you want to remove Xfce desktop? (y/n)"
...
if [ "$choice" = "y" ] || [ "$choice" = "Y" ]; then
    ...
    print_info "Keeping Xfce desktop installed."
fi
