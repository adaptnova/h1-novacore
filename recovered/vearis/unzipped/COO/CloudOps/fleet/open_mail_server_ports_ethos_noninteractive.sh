#!/bin/bash
# Script to open required ports for the mail server on the ethos server (non-interactive version)
# Created: 2025-03-29
...
# Login to IBM Cloud with region specified
print_info "Logging in to IBM Cloud (us-south region)..."
ibmcloud login -u chase@levelup2x.com -p '@@ALALzmzm102938!!' -r us-south
