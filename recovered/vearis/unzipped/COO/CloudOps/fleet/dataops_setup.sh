#!/bin/bash
# Script to set up the "vertex" user on DataOps servers
# Created: 2025-03-22
...
echo "Setting up user '$USERNAME' on DataOps server..."
...
echo "Setup completed for user '$USERNAME' on DataOps server."