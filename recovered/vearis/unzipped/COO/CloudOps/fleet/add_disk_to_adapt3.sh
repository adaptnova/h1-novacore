#!/bin/bash
# Script to add a 1TB disk to adapt3, format it as XFS, and mount it as /llms
# Created: 2025-03-22
...
ibmcloud is instance-volume-attachment-add llms $SERVER_NAME $VOLUME_ID
