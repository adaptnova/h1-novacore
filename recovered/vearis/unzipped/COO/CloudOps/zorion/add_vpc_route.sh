...
section "Getting Subnet Gateway IP"
log "Getting subnet gateway IP..."
GATEWAY_IP=$(ibmcloud is subnet $SUBNET_ID --output json | jq -r '.gateway.address')
...
log "Using gateway IP: $GATEWAY_IP"
log "Using zone: $ZONE"
