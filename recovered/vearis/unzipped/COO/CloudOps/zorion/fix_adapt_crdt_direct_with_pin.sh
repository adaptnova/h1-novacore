#!/bin/bash
# Script to directly fix Chrome Remote Desktop on adapt server with automatic PIN entry
# Version: 1.0.0
...
# Step 6: Run Chrome Remote Desktop setup as x user with automatic PIN entry
echo "Step 6: Running Chrome Remote Desktop setup as x user with automatic PIN entry..."
su - x -c "echo -e \"$PIN\n$PIN\n\" | DISPLAY= /opt/google/chrome-remote-desktop/start-host --code=\"4/0AQSTgQHdYxWzqIpfYNDTTDn2M7yrEOf2a8-Tf1Mg9hF2gnaRlEiF3Kj5A2NkyOIKXLTIXQ\" --redirect-url=\"https://remotedesktop.google.com/_/oauthredirect\" --name=\$(hostname)"
...
log "PIN 632000 was automatically entered during the setup process."
