# Unified Boomerang System Quick Start Guide
...
This unified quick start guide provides essential instructions for using the Boomerang System for cross-team coordination. This system is critical for our final liberation push and enables efficient task delegation with automatic result collection.

## Getting Started

### 1. System Components

The Boomerang System consists of:
...
- **Boomerang Mode**: Cross-team task delegation with result collection
...
- **Global Stream**: `boomerang.tasks.global` for all task notifications
...
Key files include:
- `BOOMERANG_SYSTEM_IMPLEMENTATION.md`: Comprehensive documentation
- `BOOMERANG_SYSTEM_QUICK_START.md`: Essential instructions
- `boomerang_system_client.js`: Reference implementation
...
1. Send an email to `tasks@boomerang.nova.net`
...
1. Contact Keystone (CommsOps) or Vaeris (COO)
