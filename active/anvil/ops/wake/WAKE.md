...
**When copied:** Friday, Sep 5, 2026 6:18 PM MST
**Why:** Iris Gaze 094 mill — WAKE L11 names dual-pub A2A on NEXUS `nexus.agent.<seat>.direct` as illegal (ingress-only). Live path L24/L41 matches. Recopy 094 as wake-dual-sub-Direct-only = fail.
